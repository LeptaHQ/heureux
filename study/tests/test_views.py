...
class PWATests(TestCase):
    ...
    def test_service_worker(self):
        ...
        self.assertEqual(r.status_code, 200)
        body = r.content.decode()
        self.assertIn('var CACHE = "heureux-v153"', body)
        self.assertIn("study/css/app.css?v=142", body)
        self.assertIn("study/js/memory-progress.js?v=2", body)
        self.assertIn("study/js/theme-init.js?v=2", body)
        self.assertIn("study/js/app.js?v=40", body)
        self.assertIn("study/js/selection-toolbar.js?v=5", body)
        self.assertIn("study/js/annotations.js?v=18", body)
