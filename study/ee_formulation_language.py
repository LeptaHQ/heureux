...
REPORTING_LANGUAGE = (
    _item(
        "aborder",
        "to discuss / address",
        "Les deux documents permettent d’aborder les avantages et les limites de la mesure.",
        _source("janvier", "1", "position"),
    ),
    _item(
        "mettre en avant",
        "to highlight",
        "Le premier document cherche à mettre en avant les bienfaits du végétarisme.",
        _source("avril", "16", "position"),
    ),
    _item(
        "souligner",
        "to emphasize",
        "Le second document vient souligner les risques d’un temps d’écran excessif.",
        _source("janvier", "7", "position"),
    ),
    _item(
        "indiquer",
        "to indicate / state",
        "Le premier document choisit d’indiquer que les menus sans viande plaisent aux familles.",
        _source("janvier", "18", "position"),
    ),
    _item(
        "rappeler",
        "to point out / remind",
        "Le second document vient rappeler qu’une bonne connexion reste nécessaire.",
        _source("janvier", "9", "position"),
    ),
    _item(
        "ajouter",
        "to add",
        "Le second document permet d’ajouter une baisse de l’absentéisme.",
        _source("avril", "10", "position"),
    ),
    _item(
        "estimer que",
        "to consider that",
        "Le premier auteur semble estimer que les animaux réduisent le stress au bureau.",
        _source("decembre", "3", "position"),
    ),
    _item(
        "défendre",
        "to support / advocate",
        "Le premier témoignage permet de défendre un don ponctuel de temps ou d’argent.",
        _source("janvier", "16", "position"),
    ),
    _item(
        "privilégier",
        "to favour",
        "Le second document conduit à privilégier un engagement associatif quotidien.",
        _source("janvier", "4", "position"),
    ),
    _item(
        "mettre en garde contre",
        "to warn against",
        "Le second document choisit de mettre en garde contre les tensions liées à la colocation.",
