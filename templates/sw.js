...
var CACHE = "heureux-v160";
var SHELL = [
  "{% url 'offline' %}",
  "{% static 'study/css/app.css' %}?v=146",
  "{% static 'study/js/theme-init.js' %}?v=2",
  "{% static 'study/js/app.js' %}?v=45",
  "{% static 'study/js/selection-toolbar.js' %}?v=6",
  "{% static 'study/js/annotations.js' %}?v=22",
