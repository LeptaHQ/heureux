...
class PWATests(TestCase):
    ...
    def test_service_worker(self):
        ...
        self.assertEqual(r.status_code, 200)
        body = r.content.decode()
        self.assertIn('var CACHE = "heureux-v149"', body)
        self.assertIn("study/css/app.css?v=138", body)
        ...
        self.assertIn("study/js/selection-toolbar.js?v=2", body)
        self.assertIn("study/js/annotations.js?v=17", body)
