...
urlpatterns = [
    ...
    path(
        "expression/ecrite/tache-3/formulations/langue/<slug:slug>/<slug:item_id>/progression/",
        formulations.formulation_language_learned,
        name="ee_formulation_language_progress",
    ),
    path(
    ...
    path(
        "expression/orale/tache-2/vocabulaire-par-theme/"
        "<slug:theme_slug>/",
        views.tache_two_theme_vocabulary_detail,
    ...
    path(
        "expression/<expression_part:part_slug>/<slug:task_slug>/"
        "memoires/<int:memory_number>/reponse/",
        views.task_question_response,
        name="task_question_response",
    ),
    path(
    ...
    path(
        "expression/<expression_part:part_slug>/<slug:task_slug>/"
        "vocabulaire/themes/<slug:vocabulary_theme_slug>/"
        "fiches/<int:phrase_pk>/progression/",
        views.theme_vocabulary_progress,
        name="theme_vocabulary_progress",
    ),
    path(
        "expression/<expression_part:part_slug>/<slug:task_slug>/"
        "vocabulaire/categories/<slug:category_slug>/",
